...
# list_a = [12, 'hello', 34.0, True, [23, 888]]
# print(list_a[0])
# print(list_a[2])
# print(list_a[4][1])
#
...
#
#
# del_item = int(input('the product you bought: '))
# list_items.pop(del_item-1)
# print(list_items)
#
# list_amount = len(list_items)
# if list_amount == 0:
#    print(('you are bought all what you want'))
# else:
...
list_of_grages =  [11, 12, 10, 8, 10]
print(sum(list_of_grages))